...
void matrix_mult_transpose(const int *A, const int *B, int *C, int AX, int AY, int BY) {
    int *tmp = (int *) malloc(BIG_BY * BIG_AY * sizeof(int));
...
void smoketest() {
    ...
    matrix_mult_transpose(&a[0][0], &b[0][0], &c[0][0], 3, 2, 1);
