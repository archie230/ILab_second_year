...
#line 144 "frontend/src/parser/parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    typedef AST::INode* semantic_type;
#else
    typedef YYSTYPE semantic_type;
#endif
    /// Symbol locations.
    typedef uint32_t location_type;
    ...
    PCL_Parser (yy::PCL_Driver* driver_yyarg);
    virtual ~PCL_Parser ();
  ...
  private:
    ...
    PCL_Parser (const PCL_Parser&);
    PCL_Parser& operator= (const PCL_Parser&);
